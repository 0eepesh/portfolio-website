  ...
  const projects = [
    {
      ...
      description:
        "A secure, full-stack to-do application featuring complete user authentication and real-time database integration for persistent task management.",
    ...
    },
    {
      ...
      description:
        "A full-stack data visualization and management system demonstrating complex routing, state management, and real-time API simulation.",
  ...
  return (
    <div className="space-y-12 py-8 md:py-16 relative">
      ...
      <ScrollReveal direction="up" delay={100}>
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-zinc-400 text-lg">
            A selection of projects that showcase engineering craft,
            architectural reliability, and user-centric design.
          </p>
        </div>
      </ScrollReveal>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {projects.map((project, idx) => (
          <ScrollReveal
            ...
            className="h-full"
          >
            <div className="glass-card rounded-2xl p-8 flex flex-col justify-between text-left group relative overflow-hidden h-full">
      ...
      {showDemoModal && (
        ...
        >
          <div
            className="w-full max-w-5xl bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-scale-in"
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-zinc-900/50">
              <div className="flex items-center gap-3">
                ...
                <span className="ml-2 text-sm font-semibold text-zinc-400 font-display">
                  Acme Corp Enterprise Dashboard (Demo)
                </span>
              </div>
              <button
                onClick={() => setShowDemoModal(false)}
            ...
            <div className="p-6 overflow-y-auto space-y-6 bg-zinc-950 text-left">
              ...
              <div className="p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-200 text-sm flex items-center gap-3">
                ...
                />
                <span>
                  This is a live front-end simulation running mockup state
                  management & CSS/SVG analytical charts.
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 p-5 rounded-xl bg-zinc-900 border border-zinc-800 space-y-4">
                  <h4 className="text-sm font-bold text-zinc-300 font-display">
                ...
                <div className="p-5 rounded-xl bg-zinc-900 border border-zinc-800 space-y-4">
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        text: "Server deployment success",
                        time: "2 min ago",
                        type: "success",
                      },
                      {
                        text: "Backup snapshot complete",
                        time: "1 hour ago",
                        type: "info",
                      },
                      {
                        text: "Database connection pools high",
                        time: "3 hours ago",
                        type: "warning",
                      },
                    ].map((act, idx) => (
